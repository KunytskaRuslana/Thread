...
namespace SumArrayThreadPool
{
    class Program
    {
        ...
        {
            Console.WriteLine("*** Sum Array Thread Pool ***");
            Console.WriteLine();
            ...
            ThreadPool.QueueUserWorkItem(SumArray, doubleArray);
        ...
        private static void SumArray(object obj)
        {
            ...
            for (int i = 0; i < colRows; i++)
            {
                ...
                ThreadPool.QueueUserWorkItem(SumRow, m);
